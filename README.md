![header](https://capsule-render.vercel.app/api?type=waving&color=0:03bafc,100:FFFFFF)
...
전반적인 시스템을 **PC용 웹 서비스**로 개발한 프로젝트입니다.

<br/>

## 🔗  [배포 URL](https://6suk.github.io/pongdangpong/)
...
## ⏰ 개발 기간 및 작업 관리
- (7/17 ~ 7/21) : 기획 단계
- (7/24 ~7/28) : 로그인페이지, API 커스텀훅 , 공통 컴포넌트 제작 
- (7/31 ~8/11) : 회원관리, 예약페이지 기능 구현
- (8/07 ~8/11) : 일정관리, 회원관리, 센터관리, 마이페이지 기능 구현 및 리팩토링
<br/>
...
|  이름  |              역할              |
| :----: | :----------------------------: |
| 🐱 고예림 |   홈, 센터관리, 일정관리, 회원관리 페이지    |
| 🐹 방수빈 |  일정관리, 마이페이지 | 
| 🐻‍❄️ 김형진 |   회원관리 페이지, 공통 네비   |
<br/>
...
- **캘린더**
  ...
  ![캘린더](https://github.com/6suk/Today-I-Learned/assets/110910042/0195ad5a-a766-473c-a975-a356ab8903fd)
<br/>
...
- **개인수업 - 출석 및 결석**
  ...
  ![일정-출결](https://github.com/6suk/Today-I-Learned/assets/110910042/c7b15dd9-00b0-4e1c-8659-ee325f9f92d4)
<br/>

- **상담 - 상담 기록 등록**
  
  ![상담기록등록](https://github.com/6suk/Today-I-Learned/assets/110910042/4b6e0651-fbaa-4e49-af53-5aa382aeb4d2)
---
<br/>
...
- **서버 중복 검사**
  ...
  ![직원유효성검증](https://github.com/6suk/Today-I-Learned/assets/110910042/5e4250a9-888f-48b8-a333-b68478f805f0)
...
![footer](https://capsule-render.vercel.app/api?section=footer&type=waving&color=0:FFFFFF,100:03bafc)
